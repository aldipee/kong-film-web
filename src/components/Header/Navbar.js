...
export default function Header(props) {
  ...
  const { sections = [], title, onClickSearch, position = "static", showSearchButton = true, visible = true } = props;
      ...
      <AppBar className={classes.appbar} position={position}>
        <Toolbar className={classes.toolbar}>
          <Toolbar component="nav" variant="dense" className={classes.toolbarSecondary}>
            <Image width={130} height={50} src="https://i.ibb.co/SsMcLjn/KongFilm.png" alt="Kong Film Logo" />
